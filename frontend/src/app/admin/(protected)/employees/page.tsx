...
export default function EmployeesPage() {
  ...
  useEffect(() => {
    ...
    }).catch(() => { if (active) setError('Unable to load staff/properties.'); });
  ...
  return <section className="space-y-5 text-slate-200">
    ...
    {mode && <form onSubmit={submit} className="space-y-4 rounded-xl border border-slate-700 bg-slate-900 p-5">
      ...
      <p className="text-sm text-slate-400">No payroll or billing rates are entered. New staff require an active effective assignment before clocking.</p>
