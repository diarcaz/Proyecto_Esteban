  ...
  return (
    <div className="flex h-screen w-full bg-slate-950 text-slate-100 overflow-hidden font-sans">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-slate-950 print:bg-white print:p-0 print:overflow-visible">{permitted ? children : <p role="alert">Access Denied: missing permission for this module.</p>}</main>
      </div>
    </div>
  );
}
