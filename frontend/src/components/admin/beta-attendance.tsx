...
const metrics = [ { title: 'Active staff on-site', icon: Users, note: 'Current occupancy unavailable' }, { title: 'On-time punch rate', icon: CheckCircle2, note: 'Schedule comparison unavailable' }, { title: 'Late punches today', icon: Clock, note: 'Lateness calculation unavailable' }, { title: 'Pending approvals', icon: ClipboardList, note: 'Approval totals unavailable' } ];
